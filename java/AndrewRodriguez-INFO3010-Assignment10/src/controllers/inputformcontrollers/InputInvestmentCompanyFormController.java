...
public class InputInvestmentCompanyFormController implements ActionListener {
     ...
     * Constructor
     *
     * @param investmentCompanyDataContainer
    ...
    private void saveData() {
        ...
        try {
            ...
            Application.getAPPLICATION_LOGGER().finest("Creating investment company with the following value:"
    ...
    private void clearForm() {
        ...
        this.form.getListOfBrokers().clearSelection();
    }
